            ...
            <VisualizationDescription>
              <div className="space-y-3">
                <p>
                  ...
                  <strong>emotions classifier</strong> is a machine learning
                  model that assigns emotion scores to a text input. In this
                  case, each word associated with the character gets an emotion
                  score from the classifier and the specific emotion with the
                  highest score is associated with that word. This visualization
                  represents the corresponding word-emotion distribution for the
                  selected characters. The scores are provided for the following
                  emotions: anger, disgust, fear, joy, neutral, sadness,
                  surprise. You can experiment with the emotions classifier
                  here:{" "}
                  <a
                ...
                <p>
                  This visualization doesn&apos;t contain stop words. Stop words
                  are commonly used words such as &quot;the,&quot;
                  &quot;is,&quot; and &quot;at&quot;. These words are often
                  filtered out in text processing and search queries to focus on
