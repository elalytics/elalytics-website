...
const WordCloudDraggableDualLang = ({
  data,
  wordSizeMultiplier,
  scaleType,
}) => {
    ...
    function draw(words) {
      ...
      var text = g
        ...
        .attr("data-tooltip-html", (d) => {
          return `<div><p style="font-size:1.5em; font-weight: 600;">${d.text}/${d.translation}</p><p>Category: ${d.category}</p><p>Value: ${d.value}</p></div>`;
        })
        .text(function (d) {
          return d.text;
        })
  ...
  return (
    <div>
      <div className="text-center">
        <button
          className="px-4 py-2 bg-blue-600 hover:bg-blue-800 rounded text-white inline-block mb-1 text-sm font-bold"
...
export default WordCloudDraggableDualLang;
